...
class GrowlRegistrationPacket:
  ...
  def __init__(self, application="No application name chosen", password = None ):
    self.notifications = []
...
class GrowlNotificationPacket:
  ...
  def __init__(self, application="growlnotify",
               notification="Command-Line Growl Notification", title="No title provided",
               description="No description provided", priority = 0, sticky = False, password = None ):
    self.application  = application.encode("utf-8")
